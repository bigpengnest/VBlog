...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args) {
        Jedis jedis = new Jedis("redis://127.0.0.1:6379/10");
        jedis.zadd("FOLLOWER:17:1",new Date().getTime(),"6909");
/*
        jedis.flushDB();

        //get set
        jedis.set("hello","1111");
        print(1,jedis.get("hello"));

        jedis.rename("hello","newhello");
        print(1,jedis.get("newhello"));
        jedis.setex("hello2",15,"world");   //15秒后删除
        ...
        jedis.hset(userKey,"phone","18611626823");
        ...
        jedis.hsetnx(userKey,"school","sdu");
        jedis.hsetnx(userKey,"name","zdp");
        print(19,jedis.hgetAll(userKey));

        //set
        String likeKey1="commentLkey1";
        String likeKey2="commentLkey2";
        for(int i =0;i<10;i++){
        ...
        print(36,jedis.zrange(rankKey,1,3));        //根据数值大小从小到大排序
        print(36,jedis.zrevrange(rankKey,1,3));     //根据数值大小从大到小排序
        ...
        jedis.zadd(setKey,2,"b");
        jedis.zadd(setKey,3,"c");
        jedis.zadd(setKey,4,"d");
        jedis.zadd(setKey,5,"e");
